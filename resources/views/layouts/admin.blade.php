    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="{{ Vite::asset('resources/images/logoittscoffe.svg') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('suggestion.index') }}">
                        <span class="nav-link-text ms-1">Suggestion</span>
                    </a>
                </li>
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <form action="/logout" method="post">
                            ...
                            <button type="submit" class="nav-link btn btn-link d-flex align-items-center"><i
                                    class="bi bi-box-arrow-in-right"></i> <span class="ms-2">Log out</span></button>
                        </form>
                    </li>
                </ul>
            @endauth
